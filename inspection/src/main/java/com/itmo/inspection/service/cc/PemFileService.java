...
public class PemFileService {
    ...
    private static final String REMOTE_ORG2_RELATIVE_PATH = "/fabric-samples/test-network/organizations/peerOrganizations/org2.example.com/ca/";
    ...
    private static final String LOCAL_ORG2_RELATIVE_PATH = "org2.example.com/ca/";
    private static final String LOCAL_ORDERER_RELATIVE_PATH = "example.com/ca/";
    private static final String ORG2_FILE_NAME = "ca.org2.example.com-cert.pem";
    private static final String ORDERER_FILE_NAME = "tlsca.example.com-cert.pem";

    @PostConstruct
    private void getCerts() throws Exception {
        getRemotePemFile(REMOTE_ORG2_RELATIVE_PATH, LOCAL_ORG2_RELATIVE_PATH, ORG2_FILE_NAME);
