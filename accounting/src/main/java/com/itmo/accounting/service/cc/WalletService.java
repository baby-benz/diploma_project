...
public class WalletService {
    ...
    private static final String LOCAL_RELATIVE_PATH = "org1.example.com/ca/";
    private static final String FILE_NAME = "ca.org1.example.com-cert.pem";
    ...
    private void registerUser() throws Exception {
        ...
        try {
            ...
            enrollment = caClient.enroll("appUser", "12345", enrollmentRequestTLS);
        }
    ...
    private HFCAClient createCaClient() throws Exception {
        ...
        HFCAClient caClient = HFCAClient.createNewInstance("https://" + REMOTE_HOST + ":7054", props);
