...
public class WalletService {
    ...
    private static final String LOCAL_RELATIVE_PATH = "org3.example.com/ca/";
    private static final String FILE_NAME = "ca.org3.example.com-cert.pem";
    ...
    private void addToWallet() throws Exception {
        ...
        Identity user = Identities.newX509Identity("Org3MSP", enrollment);
    ...
    private HFCAClient createCaClient() throws Exception {
        ...
        HFCAClient caClient = HFCAClient.createNewInstance("https://" + REMOTE_HOST + ":11054", props);
